...
ax[0].axis([0,X,0,T])
ax[0].set_xticks(np.arange(0,X+1,X/5),[x_0,x_0+X*dx/5,x_0+2*X*dx/5,x_0+3*X*dx/5,x_0+4*X*dx/5,x_0+X*dx])
ax[0].set_yticks(np.arange(0,T+1,T/10),[0,T*dt/10,T*dt/5,3*T*dt/10,2*T*dt/5,T*dt/2,3*T*dt/5,7*T*dt/10,4*T*dt/5,9*T*dt/10,T*dt])
ax[1].set_xlabel("Position")
ax[1].set_ylabel("Time")
ax[1].axis([0,X,0,T])
ax[1].set_xticks(np.arange(0,X+1,X/5),[x_0,x_0+X*dx/5,x_0+2*X*dx/5,x_0+3*X*dx/5,x_0+4*X*dx/5,x_0+X*dx])
ax[1].set_yticks(np.arange(0,T+1,T/10),[0,T*dt/10,T*dt/5,3*T*dt/10,2*T*dt/5,T*dt/2,3*T*dt/5,7*T*dt/10,4*T*dt/5,9*T*dt/10,T*dt])
plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0.5, hspace=None)
ax[0].set_aspect(2*X/T)
ax[1].set_aspect(2*X/T)
plt.savefig("gudonov_lax_comparison.png")